...
$att = ListOfAttractionDetails($db_elegantp,$MyDataField='fldCountryID',$MyDataValue=183,$ORDERBY='fldAttractionTitle',$LIMIT=null); 
$details = PageDetails($db_elegantp,40); ?>

<div class="container-fluid  text-light">
    <div class="row bg-sl-attractions-hero center-cover pt-sm-13">
        <div class="col px-3 px-sm-5 pt-23">
            <h1 class="text-light fw-bolder text-uppercase pt-13 pt-xl-23">Sri Lanka Attractions</h1>
